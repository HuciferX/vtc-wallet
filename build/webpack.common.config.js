        ...
        preProcessorOptions = {
          ...
          lessOptions: {
            modifyVars: {
              ...
              'primary-color-active': '#181840',
              'input-icon-hover-color': '#e8eaf6',
              'component-background': '#08081e',
              'select-dropdown-bg': '#0c0c28',
              'select-item-selected-bg': '#101035',
              'select-item-active-bg': '#101035',
              'input-border-color': 'rgba(80,80,160,0.25)',
              borderColor: 'rgba(80,80,160,0.25)',
              'input-hover-border-color': 'rgba(0,229,255,0.4)',
              hoverBorderColor: 'rgba(0,229,255,0.4)',
              'border-color-base': 'rgba(80,80,160,0.25)',
              'border-width-base': '0',
              'animation-duration-slow': '0.08s',
              'animation-duration-base': '0.08s',
              'layout-header-background': '#0c0c28',
              ...
              'text-color': '#e8eaf6',
              'text-color-secondary': 'rgba(232,234,246,0.5)',
              'height-lg': '3.875rem',
              'checkbox-size': '1.5rem',
              'btn-text-hover-bg': '#101035',
              'input-disabled-color': 'rgba(232,234,246,0.4)'
            },
