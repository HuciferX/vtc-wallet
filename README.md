...
👉 **[Download universal-wallet-v0.6.0-chrome.zip](https://github.com/HuciferX/vtc-wallet/releases/download/v0.6.0/universal-wallet-v0.6.0-chrome.zip)** (5.8 MB)
...
- **Linux:** `unzip universal-wallet-v0.6.0-chrome.zip -d ~/vtc-wallet`
