...
👉 **[Download universal-wallet-v0.3.1-chrome.zip](https://github.com/HuciferX/vtc-wallet/releases/download/v0.3.1/universal-wallet-v0.3.1-chrome.zip)** (5.8 MB)
...
- **Linux:** `unzip universal-wallet-v0.3.1-chrome.zip -d ~/vtc-wallet`
