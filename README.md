...
👉 **[Download universal-wallet-v0.5.2-chrome.zip](https://github.com/HuciferX/vtc-wallet/releases/download/v0.5.2/universal-wallet-v0.5.2-chrome.zip)** (5.8 MB)
...
- **Linux:** `unzip universal-wallet-v0.5.2-chrome.zip -d ~/vtc-wallet`
