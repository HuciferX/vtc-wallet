...
👉 **[Download vtc-wallet-v0.2.0-chrome.zip](https://github.com/HuciferX/vtc-wallet/releases/download/v0.2.0/vtc-wallet-v0.2.0-chrome.zip)** (5.8 MB)
...
- **Linux:** `unzip vtc-wallet-v0.2.0-chrome.zip -d ~/vtc-wallet`
